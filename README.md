...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? 
 ...
 Semantic HTML is html that describes what is happened or the content on the page.
...
Y-Axis when in Row, X-Axis when in Column

4. Explain why git is valuable to a team of developers.

Because not only does it backup your work in layers of commits, it keeps track of who did what and allows for a team to work seemlessly together.

5. Define mobile-first design in your own words.

Designing from Mobile up. You build out your core styles in Mobile and then do break points to accomidate the tablet and desktop views.
